  ...
  return (
    <html lang="sr-Latn" dir="ltr" suppressHydrationWarning>
      <head>
        ...
        {/* Preload the hero image (the LCP element) — images are `unoptimized` on
            Workers, so the hero loads the direct /images/hero.webp URL, not the old
            /_next/image optimizer URL. The preload must match the used URL or it's a
            wasted download that doesn't help LCP. */}
